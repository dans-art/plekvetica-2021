...
<div class="event-band-container plek-event-form-container">
    <div id="band-search-bar-container" class="event-search-bar-container">
        <input type="text" name="event_band" id="event_band" class="input plek-search-input" autocomplete="off" placeholder="<?php echo __('Search a band', 'plekvetica'); ?>" />
    </div>
    ...
    <div class="event-band-none-checkbox">
        <input type="checkbox" name="no_band" id="no_band" class="input" value="<?php echo ($event_object->is_multiday()) ? '1' : '0'; ?>" autocomplete="off" />
        <label class="checkbox-label" for="no_band"><?php echo __('No bands are known for this event yet.', 'plekvetica'); ?></label>
    </div>
