...
?>
<?php PlekTemplateHandler::load_template('text-bar', 'components', __('Date & Time', 'pleklang')); ?>
<div class="meta-content">
    <dl>
        <dt><?php echo __('Date','pleklang'); ?></dt>
        <dd>
            <span class="date-from"><?php echo date_i18n('l, d M Y', $stime); ?></span>
            <?php if (date_i18n('l, d M Y', $stime) != date_i18n('l, d M Y', $etime)): ?>
                <span class="date-seperator"><?php echo __('to','pleklang'); ?></span>
                <span class='date-to'><?php echo date_i18n('l, d M Y', $etime); ?></span>
            <?php endif;?>
        </dd>
        <dt><?php echo __('Time','pleklang'); ?></dt>
