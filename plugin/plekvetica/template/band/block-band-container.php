...
$items = array('herkunft' => __('Origin', 'plekvetica'),
'name' => __('Bandname', 'plekvetica'),
'count' => __('Events', 'plekvetica'),
'future_count' => __('Future Events', 'plekvetica'),
'band_follower' => __('Follower', 'plekvetica'));

if($plek_user -> user_is_in_team()){
$items['band_score'] = __('Bandscore','plekvetica');
}
?>
