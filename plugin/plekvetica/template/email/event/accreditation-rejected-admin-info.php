...
$reason = $pe -> get_accreditation_note();

?>

<div>
    <?php echo sprintf(__('The Event %s got rejected by the organizer.', 'plekvetica'), $event_name); ?>
    <br />
    <ul>
        <li><?php echo __('Organizer', 'plekvetica') ?>: <?php echo tribe_get_organizer($organizer_id); ?></li>
        <li><?php echo __('Media contact', 'plekvetica') ?>: <?php echo (is_array($organi_contact)) ? implode(', ', $organi_contact) : $organi_contact; ?></li>
        <li><?php echo __('Date of rejection','plekvetica'); ?>: <?php echo $date; ?></li>
        <li><?php echo __('Reason','plekvetica'); ?>: <br/><?php echo $reason; ?></li>
    </ul>
</div>