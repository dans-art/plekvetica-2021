...
global $plek_handler;
$my_plekvetica_link = '<a href="' . $plek_handler->get_my_plekvetica_link() . '" target="_blank">My Plekvetica</a>';
?>
<div style="background-color:<?php echo $email_bg_dark; ?>; padding: 20px;  margin: 0;">
