...
var plekevent = {
    ...
    prepare_data(type, form) {
        ...
        if (type === 'save_edit_event') {
            datab.append('event_ticket_raffle', !empty(this.get_field_value('event_ticket_raffle')) ? this.get_field_value('event_ticket_raffle') : '');
            datab.append('event_ticket_raffle_conditions', !empty(this.get_field_value('event_ticket_raffle_conditions')) ? this.get_field_value('event_ticket_raffle_conditions') : '');
            ...
            datab.append('event_team', this.get_field_value('event_team'));
        }
