let plek_team_cal = {
    ...
    accreditation_request(item){
        ...
        const confirm_message = __(`Do you wanna send a accreditation request to:\r\n${media_name} (${media_email})?`,'pleklang');
    ...
    accreditation_request_all(item){
        ...
        const confirm_message = __(`Do you wanna send ${count} accreditation requests to:\r\n${media_name} (${media_email})?`,'pleklang');
