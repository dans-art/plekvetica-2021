...
?>
<article class="event-<?php echo $event->get_ID(); ?> tribe-events-calendar-list__event tribe-common-g-row tribe-common-g-row--gutters tribe_events type-tribe_events status-publish has-post-thumbnail hentry">
