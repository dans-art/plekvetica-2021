...
<div class="band-list-item">
    <div class="band band-<?php echo $plek_band->get_id(); ?>">
        ...
        <div>
            <div class="band-name">
                <a href='<?php echo $plek_band->get_band_link(); ?>' title='<?php echo sprintf(__('Bandpage von &quot;%s&quot;', 'pleklang'), htmlspecialchars($plek_band->get_name(), ENT_QUOTES)); ?>'><?php echo $plek_band->get_name(); ?></a>
            </div>
