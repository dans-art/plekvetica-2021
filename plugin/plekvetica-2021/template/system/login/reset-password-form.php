...
<div class='reset-password'>
	<form name="lostpasswordform" id="lostpasswordform" action="<?php echo site_url(); ?>/plek-login/?action=lostpassword" method="post">
		...
		<p class="submit">
			<input type="submit" data-type="resetpassword" name="wp-submit" id="plek-submit" class="button button-primary button-large" value="<?php echo __('Request new password', 'pleklang'); ?>">
		</p>
	</form>
</div>