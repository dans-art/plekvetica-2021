...
<div class='reset-password'>
	<form name="set_new_password_form" id="set_new_password_form" action="<?php echo site_url(); ?>/plek-login/?action=rp" method="post">
		...
		<p class="submit">
			<input type="submit" data-type="set_new_password" name="wp-submit" id="plek-submit" class="button button-primary button-large" value="<?php echo __('Set new password', 'pleklang'); ?>">
		</p>
	</form>
	<a href="<?php echo $plek_handler->get_my_plekvetica_link(); ?>" style="display:none;" id="to-my-plek-page-button" class="plek-button"><?php echo __('Go to Login', 'pleklang'); ?></a>
</div>