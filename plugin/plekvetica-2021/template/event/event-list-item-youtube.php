...
<article class="tribe-events-calendar-list__event <?php echo $event -> get_event_classes(); ?>">
    ...
    <div class="tribe-events-calendar-list__event-featured-image-wrapper tribe-common-g-col">
        <a href="<?php echo $event->get_permalink(); ?>" title="<?php echo  sprintf(__('%s auf Youtube ansehen.','pleklang'),$name_strippted); ?>" target="_blank" class="tribe-events-calendar-list__event-featured-image-link">
    ...
    <div class="tribe-events-calendar-list__event-details tribe-common-g-col">
        <header class="tribe-events-calendar-list__event-header">
            ...
            <h3 class="tribe-events-calendar-list__event-title tribe-common-h6 tribe-common-h4--min-medium">
                <a href="<?php echo $event->get_permalink(); ?>" title="<?php echo  sprintf(__('%s auf Youtube ansehen.','pleklang'),$name_strippted); ?>" target="_blank" class="tribe-events-calendar-list__event-title-link tribe-common-anchor-thin"><?php echo $name_strippted; ?></a>
            </h3>
