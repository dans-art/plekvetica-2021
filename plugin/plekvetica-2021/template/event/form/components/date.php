	...
	<div class="event-date-container">
		...
		<div class="event-date-picker">
			<span class="date-input-container">
				<input type="datetime-local" name="event_start_date" id="event_start_date" class="input" value="<?php echo $start_date; ?>" />
			</span>
			...
			<span class="date-input-container plek-multi-date" style="display: none;">
				<input type="datetime-local" name="event_end_date" id="event_end_date" class="input" value="<?php echo $end_date; ?>" />
			</span>
		</div>
	</div>
