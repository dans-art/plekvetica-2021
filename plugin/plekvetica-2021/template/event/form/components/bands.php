...
?>
<div class="event-band-container">
    <div id="band-search-bar-container" class="event-search-bar-container">
        <input type="text" name="event_band" id="event_band" class="input plek-search-input" placeholder="<?php echo __('Suche nach einer Band', 'pleklang'); ?>" /><span class="plek-button"><?php echo __('Finde', 'pleklang'); ?></span>
        <?php PlekTemplateHandler::load_template('search-overlay','event/form/components', __('Bands','pleklang')); ?>
    </div>
