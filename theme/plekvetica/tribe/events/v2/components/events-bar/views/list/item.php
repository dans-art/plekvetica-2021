 ...
 * @version 5.3.0
*/
$add_label = __('Add event','plekvetica');
...
?>
<?php if($public_view_data -> view_label === $add_label): ?>
	<li class="<?php echo esc_attr( implode( ' ', $list_item_classes ) ); ?>">
		<a href="<?php echo esc_url( $public_view_data->view_url );?>"
		class="tribe-events-c-view-selector__list-item-link">
		<i class="far fa-calendar-plus add-event"></i><span><?php echo $add_label;?></span>
	</a>
	</li>
<?php else: ?>
	<li class="<?php echo esc_attr( implode( ' ', $list_item_classes ) ); ?>">
